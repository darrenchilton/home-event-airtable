...
> Generated from Airtable schema on 2025-12-13 12:10:22
...
- **Field ID**: `fldz1jEyaOTsHMItk`
- **Type**: Multilinetext

### Automation Name

- **Field ID**: `fldYkGKXA1bkONzgn`
- **Type**: Multilinetext

### Category

- **Field ID**: `fld3Rh6awNA4TsJ1A`
- **Type**: Single Select (10 options)
- **Options**:
  - Events (blueLight2)
  - Words to learn (cyanLight2)
  - Timer (tealLight2)
  - Research (greenLight2)
  - Financial (yellowLight2)
  - Media Hard Drives (orangeLight2)
  - Job search (redLight2)
  - More (pinkLight2)
  - Events / Recurrence (blueLight2)
  - Data Integrity (cyanLight2)

### Complexity

- **Field ID**: `fldKtoj2LYBxKNtqp`
- **Type**: Multilinetext

### Conditions Summary

- **Field ID**: `fldpDk56peRU10Eij`
- **Type**: Multilinetext

### Created time

- **Field ID**: `fld7Ri9UfEmMkreip`
- **Type**: Createdtime

### Dependencies

- **Field ID**: `fldDUaxd33uWUJhzT`
- **Type**: Multilinetext

### Dependent On

- **Field ID**: `fldwCaAV0eUH7muO0`
- **Type**: Multilinetext

### Documentation Status

- **Field ID**: `fldphJ21ECcdAmmrp`
- **Type**: Single Select (11 options)
- **Options**:
  - Not Started (blueLight2)
  - Medium (cyanLight2)
  - Low (tealLight2)
  - High (greenLight2)
  -  (yellowLight2)
  - Core Google Calendar sync (orangeLight2)
  - Updates existing calendar events (redLight2)
  - Complete (blueLight2)
  - Updated (blueLight2)
  - New (cyanLight2)
  - Deprecated (tealLight2)

### Documented By

- **Field ID**: `fldk9EHSwO511kev3`
- **Type**: Single Select (9 options)
- **Options**:
  - 2025-11-29 (blueLight2)
  -  (cyanLight2)
  - Not Started (tealLight2)
  - Medium (greenLight2)
  - High (yellowLight2)
  - Claude (blueLight2)
  - Darren (blueLight2)
  - Annual/Monthly (blueLight2)
  - ChatGPT (blueLight2)

### Fields Referenced

- **Field ID**: `fldquSajmXC6aKZrG`
- **Type**: Multiple Select (55 options)
- **Options**:
  - Sub Type (blueLight2)
  - Record ID (cyanLight2)
  - Status (blueLight2)
  - Appt Type (cyanLight2)
  - Title (likely) (tealLight2)
  - Start Time (likely) (greenLight2)
  - Description (likely) (yellowLight2)
  - Title (in email) (blueLight2)
  - Start Time (in email) (cyanLight2)
  - Description (in email) (tealLight2)
  - Actual run time (dynamic date in subject) (greenLight2)
  - Research Type (blueLight2)
  - Name (blueLight2)
  - Month Delay (blueLight2)
  - Word Blackout (cyanLight2)
  - Created (At) (tealLight2)
  - SelectionCount (greenLight2)
  - Last day selected (yellowLight2)
  - CurDate (orangeLight2)
  - Force (redLight2)
  - Seconds After (blueLight2)
  - Date Check (cyanLight2)
  - Year Add (tealLight2)
  - Month Add (greenLight2)
  - Alerts Trigger (blueLight2)
  - Alerts (cyanLight2)
  - End Time (tealLight2)
  - Since Updated (blueLight2)
  - Start Time (cyanLight2)
  - New Event in X Days (blueLight2)
  - Sub Record (cyanLight2)
  - Location (tealLight2)
  - Description (greenLight2)
  - Phone (yellowLight2)
  - New Date (orangeLight2)
  - Participants (redLight2)
  - Add to Google (pinkLight2)
  - Title (purpleLight2)
  - All Day Event? (grayLight2)
  - Notes (blueLight1)
  - Attachments (cyanLight1)
  - Parent Record (tealLight1)
  - Parent Record ID (greenLight1)
  - Anniversary Next Year (blueLight2)
  - Anniversary Next Month (blueLight2)
  - All Day Event? checked (blueLight2)
  - Start Updates Check (blueLight2)
  - Update GCal? (cyanLight2)
  - G Cal Event ID (blueLight2)
  - Sub Record ID (blueLight2)
  - Parent (blueLight2)
  - Children (do not edit) (via dependency) (cyanLight2)
  - Prev Parent (new) (via dependency) (tealLight2)
  - Children (do not edit) (greenLight2)
  - Prev Parent (new) (yellowLight2)

### Last Updated

- **Field ID**: `fld2CiyCMayUqSQB4`
- **Type**: Single Select (6 options)
- **Options**:
  -  (blueLight2)
  - Not Started (cyanLight2)
  - 2025-11-29 (blueLight2)
  - 2025-12-01 (blueLight2)
  - Appt Type, Status, Alerts Trigger, Add to Google, All Day Event?, End Time, Start Time (blueLight2)
  - 2025-12-12 (blueLight2)

### Notes

- **Field ID**: `fldRMLLnpZRk3gLIg`
- **Type**: Multilinetext

### Priority

- **Field ID**: `fld1fJ7KZjMxVfh0D`
- **Type**: Multilinetext

### Screenshots

- **Field ID**: `fldyN2wXwdkHCDt3o`
- **Type**: Multipleattachments

### Script Code

- **Field ID**: `fldKdtCuzCyBgGmog`
- **Type**: Multilinetext

### Status

- **Field ID**: `fldzLUt4Zf9QbDw97`
...
- **Field ID**: `fld7zavCuPkCMY8zH`
- **Type**: Multilinetext

### Trigger Details

- **Field ID**: `fldRoluZ1wB7j571x`
- **Type**: Multilinetext

### Trigger Type

- **Field ID**: `fldSjfCNR41gecKr3`
- **Type**: Single Select (13 options)
- **Options**:
  - Scheduled (blueLight2)
  - Record enters view (cyanLight2)
  - Record matches conditions (tealLight2)
  - Record updated (greenLight2)
  - Outlook email received (yellowLight2)
  - Record created (orangeLight2)
  - Form submitted (redLight2)
  - Google Calendar event created (pinkLight2)
  - When record enters a view (blueLight2)
  - Scheduled time (blueLight2)
  - When record is updated (blueLight2)
  - When record updated (blueLight2)
  - When record created (cyanLight2)

### Views Used

- **Field ID**: `fld4DG2MPXvny2Ybr`
- **Type**: Multilinetext
...
- **Type**: Link to Unknown
- **Linked Table ID**: `tblr2S89c8GqxDW2K`
- **Inverse Link Field**: `fldLwomIYbj4qoImj`
...
- **Type**: Link to Unknown
- **Linked Table ID**: `tblr2S89c8GqxDW2K`
- **Inverse Link Field**: `fldfB82BELLBiZ1ux`
...
- **Type**: Link to Unknown
- **Linked Table ID**: `tblr2S89c8GqxDW2K`
- **Inverse Link Field**: `fldTeuwQpekR9bCxf`
...
- **Field ID**: `fldYfDB0v1fuxLGmU`
- **Type**: Formula
- **Description**: Calculates the date that is 14 days after the Created (At) timestamp.
- **Formula**: `DATEADD({fldSty6lcRfzEZgG9}, 14, 'days')`
- **Result Type**: date

### AI Prompt

- **Field ID**: `fldgI0qLp0chg865h`
- **Type**: Multilinetext

### Add to Google

- **Field ID**: `fldilSECpHh4g5Elm`
- **Type**: Checkbox

### Address (from Health Care Provider)

- **Field ID**: `fldMO7cNgBv8v3BS2`
- **Type**: Multiplelookupvalues

### Alert w Day

- **Field ID**: `fldLH7ZtD6vKLItal`
- **Type**: Formula
- **Formula**: `CONCATENATE(DATETIME_FORMAT({fldxfiwwII0L14g3v},"MM-DD"),DATETIME_FORMAT({fldxfiwwII0L14g3v}," dd HH:mm"))`
- **Result Type**: singleLineText

### Alerts

- **Field ID**: `fld0cboRFEWtNiAtx`
- **Type**: Formula
- **Description**: Generates alerts based on the number of days, hours, or seconds until an event.
- **Formula**: `IF({fldlqlhgDBZoS5uqj} < 1, 'happening soon', IF({fldlqlhgDBZoS5uqj} < 3, 'less than 3 hours until', IF({fldAntSaUJYFNI3v1} = 120, '4 months out', IF({fldAntSaUJYFNI3v1} = 90, '3 months out', IF({fldAntSaUJYFNI3v1} = 60, '2 months out', IF({fldAntSaUJYFNI3v1} = 30, '1 month out', IF({fldAntSaUJYFNI3v1} = 14, '14 days out', IF({fldAntSaUJYFNI3v1} = 7, '7 days out', IF({fldAntSaUJYFNI3v1} = 3, '3 days out', IF({fldAntSaUJYFNI3v1} = 0, 'less than a day away', IF({fldAntSaUJYFNI3v1} < 0, 'past', '')))))))))))`
- **Result Type**: singleLineText

### Alerts Trigger

- **Field ID**: `flduKJMHaeVhHbWyb`
- **Type**: Checkbox

### All Day Event?

- **Field ID**: `fldXRoxKp0vW8xLC1`
- **Type**: Checkbox

### Anniversary Next Month

- **Field ID**: `fldVIcvzxoi8umJiu`
- **Type**: Formula
- **Formula**: `DATEADD({fldxfiwwII0L14g3v}, 1,'month')`
- **Result Type**: date

### Anniversary Next Year

- **Field ID**: `fldg9SM3HRlNsujTu`
- **Type**: Formula
- **Formula**: `DATEADD({fldxfiwwII0L14g3v}, 1,'year')`
- **Result Type**: date

### Appt Type

- **Field ID**: `fldKWMiEagCrYo1T6`
- **Type**: Single Select (41 options)
- **Options**:
  - Add to Plex (redBright)
  - AI (yellowDark1)
...
- **Field ID**: `fldTi6tZ664JouEPp`
- **Type**: Formula
- **Formula**: `RIGHT(LEFT({fldseHCLDpLVeYoFD},
LEN({fldseHCLDpLVeYoFD}) - 1),
LEN(LEFT({fldseHCLDpLVeYoFD},
LEN({fldseHCLDpLVeYoFD}) - 1)) -
SEARCH("https://", {fldseHCLDpLVeYoFD}) + 1)`
- **Result Type**: singleLineText

### Attachments

- **Field ID**: `fldseHCLDpLVeYoFD`
- **Type**: Multipleattachments

### Autonumber

- **Field ID**: `fld53qOtfTNBpTNa0`
- **Type**: Autonumber

### Base64 Encoded ID

- **Field ID**: `fldAe7XldABfPpqRN`
- **Type**: Singlelinetext
- **Description**: Extracts the event ID from the G Cal Event URL field and encodes it in base64.

### ChatGPT URL

- **Field ID**: `fldXPSFWjzYCXqrFM`
- **Type**: Url

### Check Delay

- **Field ID**: `fld28RxAqqfRvwrhw`
- **Type**: Formula
- **Description**: Indicates whether the 'Month Delay' field is checked and it has been at least 30 days since the last update of the record.
- **Formula**: `IF(AND({fldcEQpUvJldMPofq}, DATETIME_DIFF(TODAY(), {fldPfTmuER0gcXk7w}, 'days') >= 30), "Yes", "No")`
- **Result Type**: singleLineText

### Claude.AI URL

- **Field ID**: `fldCtVvyWp7p4HXOK`
- **Type**: Url

### Company

- **Field ID**: `fldL0XCNQ8ngeG8aJ`
- **Type**: Singlelinetext

### Convert Created Date

- **Field ID**: `fldeTiLWLLV6KgxmW`
- **Type**: Formula
- **Formula**: `DATETIME_FORMAT({fldSty6lcRfzEZgG9},'YY-MM-DD')`
- **Result Type**: singleLineText

### Created (At)

- **Field ID**: `fldSty6lcRfzEZgG9`
- **Type**: Createdtime

### Created Month/Year

- **Field ID**: `fld2VLmW1KhmxD1yC`
- **Type**: Formula
- **Formula**: `CONCATENATE(DATETIME_FORMAT({fldSty6lcRfzEZgG9},'MM'),"-",DATETIME_FORMAT({fldSty6lcRfzEZgG9},"YYYY"))`
- **Result Type**: singleLineText

### Current Date

- **Field ID**: `fldr9uyKpx93dBnYz`
- **Type**: Formula
- **Description**: Formats the current date and time to 'YYYY-MM-DD HH:MM'
- **Formula**: `DATETIME_FORMAT(SET_TIMEZONE(TODAY(), 'America/New_York'), 'YYYY-MM-DD HH:mm')`
- **Result Type**: singleLineText
...
- **Field ID**: `fldnlz0GIxOiUI7R3`
- **Type**: Checkbox

### Date Check

- **Field ID**: `fld9ZhhRfqTLv463x`
- **Type**: Formula
- **Formula**: `DATETIME_DIFF({fldX8d7D7e7ekSPll},{fldxfiwwII0L14g3v},'minutes')`
- **Result Type**: number

### Date for Alerts

- **Field ID**: `fldKMz4WenPrkCiDQ`
- **Type**: Formula
- **Description**: Formats the Start Time to 'YYYY-MM-DD HH:mm' for 24-hour time display.
- **Formula**: `DATETIME_FORMAT({fldxfiwwII0L14g3v}, 'YYYY-MM-DD HH:mm')`
- **Result Type**: singleLineText

### Days Until

- **Field ID**: `fldAntSaUJYFNI3v1`
- **Type**: Formula
- **Formula**: `DATETIME_DIFF({fldxfiwwII0L14g3v},NOW(),'days')`
- **Result Type**: number

### Description

- **Field ID**: `fldIyXcGCsyYY0Oew`
- **Type**: Richtext

### Difference from Midnight

- **Field ID**: `fldpc54f0bx7b3aim`
- **Type**: Formula
- **Description**: Calculates the difference in hours and minutes between the Start Time and the Set To Midnight field, which sets the Start Time to midnight of the same day.
- **Formula**: `CONCATENATE(
  FLOOR(DATETIME_DIFF({fldxfiwwII0L14g3v}, {fldMzvkOYMwmzoNof}, 'hour')), "h ",
  MOD(DATETIME_DIFF({fldxfiwwII0L14g3v}, {fldMzvkOYMwmzoNof}, 'minute'), 60), "m"
)`
- **Result Type**: singleLineText

### Effort (minutes)

- **Field ID**: `fldSehilh8cJadp3F`
- **Type**: Formula
- **Formula**: `DATETIME_DIFF({fldX8d7D7e7ekSPll},{fldxfiwwII0L14g3v},'minutes')`
- **Result Type**: number
...
- **Field ID**: `fldJWrneU5la4uwxm`
- **Type**: Checkbox

### End Date w/o Time

- **Field ID**: `fldkcR7zWR77FQnLE`
- **Type**: Formula
- **Formula**: `{fldX8d7D7e7ekSPll}`
- **Result Type**: date

### End Time

- **Field ID**: `fldX8d7D7e7ekSPll`
- **Type**: Datetime
- **Date Format**: us
- **Time Format**: 24hour
- **Time Zone**: America/New_York
...
- **Field ID**: `fldSr6xSwuXLrEAyi`
- **Type**: Singlelinetext

### Force Into Random Report

- **Field ID**: `fldIVO80CR2xFgFrN`
- **Type**: Checkbox

### Force Update

- **Field ID**: `fldN8Druz1jlxeLMP`
- **Type**: Singlelinetext

### From GCal

- **Field ID**: `fldIuuGrDXdmo1hws`
- **Type**: Checkbox

### G Cal Event ID

- **Field ID**: `fldVb1BvJtrYNLtet`
- **Type**: Multilinetext

### G Cal Event URL

- **Field ID**: `fldWUWH6VCWR8zNAD`
- **Type**: Multilinetext

### GitHub URL

- **Field ID**: `fld3S5NZspYYplyKt`
- **Type**: Url

### Google Gemini URL

- **Field ID**: `fldw5WK1xl4Pzk45R`
- **Type**: Url

### Health Care Provider

- **Field ID**: `fldfB82BELLBiZ1ux`
- **Type**: Link to Unknown
- **Linked Table ID**: `tblo5E0sRYdBH1zh2`
- **Inverse Link Field**: `fldcEs15z1lBNnD6z`

### Hours Until

- **Field ID**: `fldlqlhgDBZoS5uqj`
- **Type**: Formula
- **Formula**: `DATETIME_DIFF({fldxfiwwII0L14g3v},NOW(),'hours')`
- **Result Type**: number

### Household Tasks

- **Field ID**: `fldikc5yy7wrFmFAK`
- **Type**: Singlelinetext

### Interface Record Detail

- **Field ID**: `fldaOCpxumpx71HNy`
- **Type**: Multilinetext

### Interface Record Detail URL

- **Field ID**: `fldHuGsvZ4PL9Eyb3`
- **Type**: Button
- **Description**: Outputs the URL from the Interface Record Detail field for use in a button.

### Job Title

- **Field ID**: `fldshlFavQwOjmq1o`
- **Type**: Singlelinetext

### Last Updated by

- **Field ID**: `fldVu8gO14UWkNTYF`
- **Type**: Lastmodifiedby

### Last day selected

- **Field ID**: `fldcPWIxuVcEt5PPG`
- **Type**: Date
- **Date Format**: local

### Learning Experience

- **Field ID**: `fldTeuwQpekR9bCxf`
- **Type**: Link to Unknown
- **Linked Table ID**: `tbla51qhgULIfKojc`
- **Inverse Link Field**: `fldQ1Diarq3yyZQez`

### Link to Research

- **Field ID**: `fldLwomIYbj4qoImj`
- **Type**: Link to Unknown
- **Linked Table ID**: `tblpdti2tAy2eINb2`
- **Inverse Link Field**: `fldvBSJXcnVTcTIJa`

### Location

- **Field ID**: `fld7DdbXo9yv1dci4`
- **Type**: Singlelinetext

### Long Text

- **Field ID**: `fldVF6vx8ivQiKp3h`
- **Type**: Richtext

### Map (from Health Care Provider)

- **Field ID**: `fldEFoHIylBF96G1p`
- **Type**: Multiplelookupvalues

### Month Add

- **Field ID**: `fldbkCB7JjLsvgBMO`
- **Type**: Checkbox

### Month Delay

- **Field ID**: `fldcEQpUvJldMPofq`
- **Type**: Checkbox

### Move Car End Date (formula)

- **Field ID**: `fldpZkcfgpQC6nC8Y`
- **Type**: Formula
- **Description**: Calculates the time 1.5 hours after the Start Time
- **Formula**: `DATEADD({fldxfiwwII0L14g3v}, 1.5, 'hour')`
- **Result Type**: dateTime

### NYS Jobs Daily Link

- **Field ID**: `fldLSQK7kF5qpJ3QZ`
- **Type**: Formula
- **Formula**: `CONCATENATE("https://statejobs.ny.gov/public/vacancyTable.cfm?searchResults=Yes&Keywords=&title=&JurisClassID=&AgID=&isnyhelp=Yes&minDate=",DATESTR(NOW()),"&maxDate=",DATESTR(NOW()) ,"&employmentType=&gradeCompareType=GT&grade=&SalMin=")`
- **Result Type**: singleLineText
...
- **Field ID**: `fld7778S1uyXxahmf`
- **Type**: Formula
- **Description**: Concatenates Title and formatted Start Time unless Appt Type is 'From Research'.
- **Formula**: `CONCATENATE({fldlNeKGmEIfMdQFU},"-",{fldeTiLWLLV6KgxmW},"-",{fld53qOtfTNBpTNa0})`
- **Result Type**: singleLineText

### New Date

- **Field ID**: `fld0rNsSqjPl3HCmW`
- **Type**: Formula
- **Formula**: `DATEADD({fldxfiwwII0L14g3v},{fldzy2Rlk32oNEqaY},'days')`
- **Result Type**: date

### New Event in Days

- **Field ID**: `fldzy2Rlk32oNEqaY`
- **Type**: Number

### Notes

- **Field ID**: `fldilCovG8w7eUzuL`
- **Type**: Richtext

### Parent Record

- **Field ID**: `fldvvzP8q1pPGHjFO`
- **Type**: Link to Unknown
- **Linked Table ID**: `tblr2S89c8GqxDW2K`

### Parent Record ID

- **Field ID**: `fldeKrJqTCKw44jfY`
- **Type**: Singlelinetext

### Participants

- **Field ID**: `fldYfwbfwdK7qXh0c`
- **Type**: Multiple Select (51 options)
- **Options**:
  - darrenchilton@gmail.com (cyanLight2)
  - slavicany@gmail.com (blueLight2)
...
- **Field ID**: `fldqr1vnHd4XCa463`
- **Type**: Url

### Phone

- **Field ID**: `fldFrYS9Mvxmm9GwA`
- **Type**: Phonenumber

### Phone (from Health Care Provider)

- **Field ID**: `fldoGDX7TbCd2l7Iq`
- **Type**: Multiplelookupvalues

### Pre-Filled Annual

- **Field ID**: `fldBvKUDjNFKbbJRs`
- **Type**: Formula
- **Formula**: `CONCATENATE(
    IF(
        "Prefilling [Add Annual Event] view in [Home Events] table in base with id 'appSX4P3En4AWPyyG'",
...
- **Field ID**: `fldhXilOSYhKPomwr`
- **Type**: Multiplelookupvalues

### Record ID

- **Field ID**: `fldINmkIdHGh1xGBx`
- **Type**: Formula
- **Formula**: `RECORD_ID()`
- **Result Type**: singleLineText
...
- **Field ID**: `fldfZkE7qQHkUROcS`
- **Type**: Formula
- **Formula**: `DATETIME_DIFF(NOW(),{fldX8d7D7e7ekSPll},'seconds')`
- **Result Type**: number

### Seconds Until

- **Field ID**: `fldA2AnPqDrL7F4Im`
- **Type**: Formula
- **Formula**: `DATETIME_DIFF({fldxfiwwII0L14g3v},NOW(),'seconds')`
- **Result Type**: number

### SelectionCount

- **Field ID**: `fldhkidOK8U1K9ty6`
- **Type**: Number

### Send Definition

- **Field ID**: `fldUzxgMsEqInuEXo`
- **Type**: Checkbox

### Set To Midnight

- **Field ID**: `fldMzvkOYMwmzoNof`
- **Type**: Formula
- **Description**: Sets the Start Time to midnight of the same day.
- **Formula**: `DATEADD(
  DATETIME_PARSE(
    DATETIME_FORMAT({fldxfiwwII0L14g3v}, 'YYYY-MM-DD') & 'T00:00:00',
    'YYYY-MM-DD\\THH:mm:ss'
  ),
  4,
  'hours'
...
- **Field ID**: `fldn7XPcTW2ASS8M9`
- **Type**: Formula
- **Formula**: `DATETIME_DIFF(NOW(),{fldSty6lcRfzEZgG9},'seconds')`
- **Result Type**: number

### Since Updated (days)

- **Field ID**: `fldkCP6yD944gIWoj`
- **Type**: Formula
- **Formula**: `DATETIME_DIFF(NOW(),{fldPfTmuER0gcXk7w},'days')`
- **Result Type**: number

### Since Updated (hours)

- **Field ID**: `fldsyHQp9nLek9Gzu`
- **Type**: Formula
- **Formula**: `DATETIME_DIFF(NOW(),{fldPfTmuER0gcXk7w},'hours')`
- **Result Type**: number

### Since Updated (seconds)

- **Field ID**: `fldEZ0MKx7i5bxqXU`
- **Type**: Formula
- **Formula**: `DATETIME_DIFF(NOW(),{fldPfTmuER0gcXk7w},'seconds')`
- **Result Type**: number

### Specialty (from Health Care Provider)

- **Field ID**: `fldZPKo3y4GfS9Xeg`
- **Type**: Multiplelookupvalues

### Start Date w/o Time

- **Field ID**: `fldKjIiO0LfemdVdP`
- **Type**: Formula
- **Formula**: `{fldxfiwwII0L14g3v}`
- **Result Type**: date

### Start Time

- **Field ID**: `fldxfiwwII0L14g3v`
- **Type**: Datetime
- **Date Format**: us
- **Time Format**: 24hour
- **Time Zone**: America/New_York
...
- **Field ID**: `fldB8Do5lhehYmr7J`
- **Type**: Checkbox

### Start Updates Check

- **Field ID**: `fldMpMW5ZfsiBdv6F`
- **Type**: Formula
- **Formula**: `DATETIME_DIFF({fldPfTmuER0gcXk7w},{fldSty6lcRfzEZgG9},'minutes')`
- **Result Type**: number

### Status

- **Field ID**: `fldY9yTucjXgH6DKe`
- **Type**: Single Select (5 options)
- **Options**:
  - Pending (blueLight2)
  - Scheduled (greenLight2)
...
- **Field ID**: `fld94xVNyxre1GRcZ`
- **Type**: Checkbox

### Sub Record

- **Field ID**: `fldZyUb7Fx4DRkazc`
- **Type**: Link to Unknown
- **Linked Table ID**: `tblr2S89c8GqxDW2K`

### Sub Record ID

- **Field ID**: `fldyyzH22ai8TOVXZ`
- **Type**: Singlelinetext

### Sub Type

- **Field ID**: `fldoBHmFaE30y6g5z`
- **Type**: Multiple Select (160 options)
- **Options**:
  - 2024 Election (cyanLight2)
  - Academic debate (redLight1)
...
- **Field ID**: `fld4RsHWG8dd4NaZv`
- **Type**: Checkbox

### Temp Field

- **Field ID**: `fldU3sFpD4keQqgLG`
- **Type**: Singlelinetext

### Timer End Time

- **Field ID**: `fldVWuMSjzrgtJ4SI`
- **Type**: Formula
- **Formula**: `NOW()`
- **Result Type**: dateTime
...
- **Field ID**: `fldlNeKGmEIfMdQFU`
- **Type**: Singlelinetext

### Truncated Description

- **Field ID**: `fldFyuIcX48AFnE4M`
- **Type**: Formula
- **Description**: Truncates the Title field to a maximum of 1000 characters
- **Formula**: `MID({fldIyXcGCsyYY0Oew}, 1, 2300)`
- **Result Type**: singleLineText

### Truncated Title

- **Field ID**: `fldLinyhgHRUt2qrZ`
- **Type**: Formula
- **Description**: Truncates the Title field to a maximum of 1000 characters
- **Formula**: `MID({fldlNeKGmEIfMdQFU}, 1, 150)`
- **Result Type**: singleLineText

### Update GCal?

- **Field ID**: `fldRk7RRWDLqTpJ6L`
- **Type**: Singlelinetext
- **Description**: Used to check if the record Google calendar fields were updated. If not the automation sets it to no so the update to google calendar does not run. 

### Updated

- **Field ID**: `fldPfTmuER0gcXk7w`
- **Type**: Lastmodifiedtime

### Website (from Health Care Provider)

- **Field ID**: `fldet5cmhtljfjane`
- **Type**: Multiplelookupvalues

### Word Blackout

- **Field ID**: `fldX8bbVaFhYs2ilq`
- **Type**: Formula
- **Description**: Determines if the current time is between 11pm and 5am, returning 'Yes' or 'No'.
- **Formula**: `IF(
  OR(
...
- **Field ID**: `fldC3FgQ3hF7nZkBS`
- **Type**: Checkbox

### Years Since

- **Field ID**: `fldp7HRECbRCFAA6T`
- **Type**: Formula
- **Description**: Calculates the number of years since the year in parentheses in the Name field. 
- **Formula**: `IF(
  REGEX_MATCH({fld7778S1uyXxahmf}, "^\\(\\d{4}\\)"),
  DATETIME_DIFF(
    TODAY(),
    DATETIME_PARSE(
      MID({fld7778S1uyXxahmf}, 2, 4),
      'YYYY'
    ),
    'years'
  ),
...
- **Field ID**: `fldcaO05ueKg9jzX1`
- **Type**: Formula
- **Formula**: `CONCATENATE("give me some humorous sentence variations on a mnemonic device for"," ",{fldlNeKGmEIfMdQFU})`
- **Result Type**: singleLineText

### pronunciation

- **Field ID**: `fldCivbdquNvvuknu`
- **Type**: Singlelinetext
